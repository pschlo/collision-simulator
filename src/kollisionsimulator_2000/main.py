...
def main():
    ...
    scale_1 = Scale(frame_input, from_=1, to=100, orient=HORIZONTAL, cursor="sb_h_double_arrow", showvalue=False, width=10,
    ...
    scale_2 = Scale(frame_input, from_=1, to=100, orient=HORIZONTAL, cursor="sb_h_double_arrow", width=10, showvalue=False,
    ...
    scale_3 = Scale(frame_input, from_=-50, to=50, orient=HORIZONTAL, cursor="sb_h_double_arrow", showvalue=False, width=10,
